...
function alterarStatusConsulta(consulta, novoStatus) {
    if (consulta.status === "Realizada" && novoStatus === "Cancelada") {
        console.log(`Não é possível cancelar a consulta #${consulta.id}: já foi realizada.`);
        return null;
    }
    return Object.assign(Object.assign({}, consulta), { status: novoStatus });
}
// Criando 5 consultas com datas e valores variados
const consulta1 = criarConsulta(1, medico1, paciente1, new Date(2026, 2, 10), 350);
const consulta2 = criarConsulta(2, medico2, paciente2, new Date(2026, 3, 5), 280);
const consulta3 = criarConsulta(3, medico3, paciente3, new Date(2026, 1, 20), 150);
const consulta4 = criarConsulta(4, medico1, paciente2, new Date(2026, 4, 15), 500);
const consulta5 = criarConsulta(5, medico2, paciente3, new Date(2026, 5, 1), 420);
